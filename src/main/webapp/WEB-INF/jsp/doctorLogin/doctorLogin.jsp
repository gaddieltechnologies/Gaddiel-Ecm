...
<form:form commandName="doctorLogin" action="" id="doctorLoginId">
...
.trclick
{
	background-color: #7EC2EB;
                                  ...
                                  <a href="#"><img src="http://placehold.it/80x80" class="messages-activity-avatar" alt="avatar1"></a>
                                        <P class="well well-message">  
                                         <span><%= session.getAttribute("user") %></span>,                                      
                                	      <span><%= session.getAttribute("doctorspecialization") %></span>.                                       
							...
							<div class="span3">                                                                
                                <div class="span3">                                                                
	                               <div class="box-holder">
	                                   <a  onclick="newPage()"><div class="box"><img src="${pageContext.request.contextPath}/resources/images/d-add.png"/>New</div></a>
	                               </div>  
	                               <div class="box-holder">
                ...
                <!-- /span9 -->
					...
					<div class="widget">					
						<div class="widget-content">
						    <div class="mobile"><h3>Profile</h3></div> 
				...
				<!-- /Content -->
	                <div class="span12 ">
	                 	<span style="color:green" id="demo"><h3>${doctorLogin.alertMessage}</h3></span>
					<div class="widget">					
						<div class="widget-content">
							...
							<!--<table class="table table-striped table-bordered">-->                            
								...
								<c:forEach  items="${doctorLogin.doctorLoginSubForm}" var="doctorLoginDetail" varStatus="gridRow" >
...
$(function(){
 ...
 <script type="text/javascript">
	 ...
	 <script>
	 var form = document.getElementById("doctorLoginId");
