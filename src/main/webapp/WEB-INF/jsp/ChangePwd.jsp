...
<form:form commandName="ChangePwd" id="log" >
<body>
    <!-- Navbar -->
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
			    <a class="brand" href="#"><img src="${pageContext.request.contextPath}/resources/images/logo90.png" Style=" width:300px; height:40px;" align="left"/></a>			
			</div>
	    </div>
	</div>
	<!-- /Navbar -->
		...
		<div class="container" >
		   	<div class="box-container">
				<div class="alert alert-success alert-block" id="sucessdiv">
					...
					<h4 id="successmessage">${ChangePwd.successmessage}</h4>
				</div>
			</div>
			<!-- Tittle Header -->
            <div class="row">
					...
					<div class="widget">                    					
					    <div class="widget-content"> 
							...
							<div class="span3">                                                                                                           
                                ...
                                <div class="box-holder"><a href="${pageContext.request.contextPath}/index"><div class="btn btn-info">logout</div></a></div>
                            </div>
					    </div>   
						...
						<div class="widget-content">
						    ...
						    <div class="row">
								...
								<div class="span7">
									...
									<span style="color:red" id="firstnames"></span>	
						        </div>
							</div>
							<div class="row">							    
								<div class="span4">
								...
								<div class="span7">
									...
									<span style="color:red" id="secondnames"></span>	
							    </div>
							</div>		
							<div class="row">		
								<div class="span4">
...
function firstname(){
	if (!document.getElementById("first").value.match(/\S/))
	{
	       ...
	       document.getElementById("firstnames").innerHTML= "please give the fistquestion answer";
...
function secondname(){
	if (!document.getElementById("second").value.match(/\S/))
	{
	       ...
	       document.getElementById("secondnames").innerHTML= "please give the secondquestion answer";
