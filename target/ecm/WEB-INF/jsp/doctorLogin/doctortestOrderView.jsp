...
<form:form commandName="doctortestOrderView" action="" id="DoctorTestOrderManagerId">
<body>
<style>
.oddtr
{
					...
					<div class="widget-content"> 
                                            ...
                                            <h3>Test Order Manager</h3>	
                                                ...
                                                <div class="span3">                                                                                                           
                                                    ...
                                                    <div class="box-holder"><a href="${pageContext.request.contextPath}/doctorLogin"><div class="box"><img src="${pageContext.request.contextPath}/resources/images/e-close.png"/>close</div></a></div>
                                                </div>                
                                        </div>                                    
                                    </div>	              
                                </div>
				   ...
				   <div class="mobile"><h3>Test Order Manager</h3>	</div> 			
						...
						<div class="widget-content">
                            ...
                            <div class="row">
                                ...
                                <input type="text" value="${doctortestOrderView.orderId}" class="span1" disabled="disable" placeholder="Order Id" id="orderId"/>
								</div>
								<div class="span2"><label>Order Date</label>
                                 <input type="text" value="${doctortestOrderView.orderDate}" class="span2" disabled="disable" placeholder="Order Date"/>
								 </div>
                                 <div class="span2"><label>Doctor</label>
                                 <input type="text" value="${doctortestOrderView.doctorName}" class="span2" disabled="disable" placeholder="Doctor"/>
								 </div>
                                 <div class="span2"><label>Vendor</label>
                                 <input type="text" value="${doctortestOrderView.vendorName}" class="span2" disabled="disable" placeholder="Vendor"/>
								 </div>								
                                 <div class="span2"><label>Order Ref</label>
                                 <input type="text" value="${doctortestOrderView.orderReference}" class="span2" disabled="disable" placeholder="Order Ref"/>
								 </div>
                                 <div class="span2"><label>Order Value</label>
                                 <input type="text" value="${doctortestOrderView.orderValue}" class="span2" disabled="disable" placeholder="Order Value"/>
								 </div>
                                 <div class="span1"><label>Discount</label>
                                 <input  type="text" value="${doctortestOrderView.discount}"  class="span1" disabled="disable" placeholder="Discount"/>
								 </div> 
                                 <div class="span2"><label>Net Value</label>
                                 <input type="text" value="${doctortestOrderView.netValue}" class="span2" disabled="disable" placeholder="Net Value"/>
								 </div> 
                                 <div class="span2"><label>Advance</label>
                                 <input type="text" value="${doctortestOrderView.advance}" class="span2" disabled="disable" placeholder="Advance"/>
								 </div>
                                 <div class="span2"><label>Balance</label>
                                 <input type="text" value="${doctortestOrderView.balance}" class="span2" disabled="disable" placeholder="Balance"/>
								 </div> 
								 <div class="span2"><label>Total Collected</label>
                                 <input type="text" value="${doctortestOrderView.totalCollected}" class="span2" disabled="disable" placeholder="Total Collected"/>
								 </div>
                            </div>                                                        
						</div>
					</div>
                    <div class="widget">	
						...
						<div class="widget-content">							
                            <div class="row">
                                ...
                                <input type="text" value="${doctortestOrderView.testGroup}" class="span4" disabled="disable" /></div>
								<div class="span4"><label>Sub Group</label>
                                 <input type="text" value="${doctortestOrderView.testSubgroup}" class="span4" disabled="disable"/></div>
                                 <div class="span3"><label>Test</label>
                                 <input type="text" value="${doctortestOrderView.tests}" class="span3" disabled="disable" /></div>                                 
                            </div>                                                     
						</div>
					</div>										
					<div class="widget">
						...
						<div class="widget-content">
                            ...
                            <div class="row">
                                ...
                                <input type="text" value="${doctortestOrderView.order}" class="span3" disabled="disable" /></div>
								<div class="span3"><label>Test Result</label>
                                 <input type="text" value="${doctortestOrderView.testResult}" class="span3" disabled="disable"/></div>
                                 <div class="span3"><label>Analyst Remarks</label>
                                 <input type="text" value="${doctortestOrderView.analystRemarks}" class="span3" disabled="disable"/></div> 
                                 <div class="span2"><label>Rate</label>
                                <input type="text" value="${doctortestOrderView.rate}" class="span2" disabled="disable"/></div>	                        
                            </div>
                               <div class="row">
								<div class="span3"><label>Specimen Details</label>
                                <input type="text" value="${doctortestOrderView.specimenDetails}" class="span3" disabled="disable" /></div>
								<div class="span3"><label>Test Job#</label>
                                 <input type="text" value="${doctortestOrderView.testjob}" class="span3" disabled="disable" /></div>
                                 <div class="span3"><label>Tested By</label>
                                 <input type="text" value="${doctortestOrderView.testedBy}" class="span3" disabled="disable" /></div> 
                                 <div class="span2"><label>Test Approved By</label>
                                <input type="text" value="${doctortestOrderView.testApprovedby}" class="span2" disabled="disable" /></div>	                        
                            </div>
                                <div class="row">
								<div class="span3"><label>Test Start Date and Time </label>
                                 <input type="text" value="${doctortestOrderView.testStarttime}" class="span3" disabled="disable" /></div>
                                 <div class="span3"><label>Test Reference</label>
                                 <input type="text" value="${doctortestOrderView.testReference}" class="span3" disabled="disable" /></div> 	                        
                            </div>
				...
				<!-- /Content -->
					...
					<div class="widget-content">
						<div class="tab-content">
							...
							<c:forEach  items="${doctortestOrderView.doctorLoginSubForm}" var="doctorLoginDetail" varStatus="gridRow" >
                ...
                <div class="container">                  
                    <center>
                        <div class="btn-group btn-group-justified">                                               
                            ...
                            <a href="${pageContext.request.contextPath}/doctorLogin" class="btn btn-default">
...
<script>
var form = document.getElementById("DoctorTestOrderManagerId");
$("#save-enable").show();
$("#save-disable").hide();
$("#SN-e").hide();
$("#SN-d").hide();
